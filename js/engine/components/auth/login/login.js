class AuthLoginComponent extends Component {
	...
	preload() {
		let html = "<div class='authLogin' style='opacity: 0'> <div class='authLoginLogo'> <h1> CODE </h1> </div> <div class='authLoginTypes'> <input id='authLogin' type='button' value='Войти' style='font-family: Whitney'> <input id='register' href='/auth/registration' type='button' value='Зарегистрироваться' style='font-weight: 100'> </div> <div class='authLoginInner'> <input type='email' placeholder='Электронная почта'> <p> Забыли электронную почту? </p> <input type='password' placeholder='Пароль'> <p> Забыли пароль? </p> </div> <div class='authLoginSubmit'> <p style='opacity: 0'></p> <input type='button' value='Отправить'> </div> <div class='authLoginRemember'> <input type='checkbox' value='remember'> <div> </div> <p> Запомнить меня в системе </p> </div> <div class='authLoginNavigate'> <input type='button' href='/migrate' value='Аккаунты, которые мы запомнили'> <input type='button' href='/' value='<— Главная'> </div> </div>";
